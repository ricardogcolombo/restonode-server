...
const createOneTime = (req, res, next) => {
    ...
    let getTimeData = fetch('https://maps.googleapis.com/maps/api/directions/json?origin='+latlongOrigin+'&destination='+req.body.lat+','+req.body.long+'&avoid=highways&mode=driving&key=AIzaSyAd-p6W--DeSwFBAIwnEBQGfnUzana88Hg');
